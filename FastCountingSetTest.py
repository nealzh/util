...
import time
from FastCountingSet import FastCountingSet
...
print(time.strftime( ISOTIMEFORMAT, time.localtime()), 'start create FastCountingSet.')
bs = FastCountingSet(cap, size)
print(time.strftime( ISOTIMEFORMAT, time.localtime()), 'end create FastCountingSet.')
